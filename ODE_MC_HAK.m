...
Jb_0 = mean(BiogenicSi.bSiFlux(1:8)); % g/cm2/yr
...
Volume = 7.043E7; % m3, calculated from lake bathymetry
...
histogram(abs(F_true-F_calculated),'Normalization','pdf',...
    'FaceColor',ng,'FaceAlpha',1,'LineWidth',1.5)
hold on
set(gca,'Xlim',[0 0.15])
set(gca,'Ylim',[0 90])
